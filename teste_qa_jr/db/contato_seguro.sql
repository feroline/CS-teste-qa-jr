...
INSERT INTO `contato_seguro`.`user` (`id_user`, `name`, `email`, `telephone`, `birth_date`, `birth_city`, `show`) VALUES
...
INSERT INTO `contato_seguro`.`user_company` (`id_user_company`, `id_user`, `id_company`) VALUES
(1, 1, 4),
(2, 1, 5),
(3, 1, 6),
(4, 3, 4),
